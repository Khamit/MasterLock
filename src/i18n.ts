...
const messages: Record<string, Record<Language, string>> = {
  ...
  error_invalid_format: {
    en: "(!) Invalid MasterLock encrypted format.",
    ru: "(!) Неверный формат шифрования MasterLock.",
    kz: "(!) MasterLock шифрлау форматы дұрыс емес."
  },

  error_corrupted_data: {
    en: "(!) Encrypted data appears to be corrupted.",
    ru: "(!) Зашифрованные данные повреждены.",
    kz: "(!) Шифрланған деректер бүлінген."
  },
  ...
  info_processing_large: {
    en: "Large selection detected. Processing may take a moment.",
    ru: "Обнаружен большой объём текста. Обработка может занять время.",
    kz: "Үлкен мәтін анықталды. Өңдеу біраз уақыт алуы мүмкін."
  },
